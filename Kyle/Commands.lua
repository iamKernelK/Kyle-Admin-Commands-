...
Commands["Cmds"]={Action=function() if KyleUI then KyleUI.Enabled=not KyleUI.Enabled end end,Description="Toggle UI"}
Commands["cc"]={Action=function() game.StarterGui:SetCore("ChatMakeSystemMessage",{Text=string.rep("\n",100)}) end,Description="Clear Chat"}
